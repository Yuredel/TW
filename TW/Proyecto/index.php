...
<div class="superCabecera">
 <div class="cabeceraLogo">
  <img src="/var/www/html/repoTW/TW/proyecto/Imagenes/emiliosantiago.png" class="logo"  width= "200 %"/>
 </div>
 ...
 <div class="menuLateral">
  <nav>
    <ul>
      ...
      <li><a href="miembros.html">Conocer a los miembros<br> del Grupo</a></li>
      <li><a href="publicaciones.html">Publicaciones</a></li>
      <li><a href="proyectos.html">Ver proyectos disponibles</a></li>
      <li><a href="sobreNosotros.html">sobrenosotros</a></li>
    </ul>
  </nav>
 </div>
 <div class="contenido">
  <img src="/var/www/html/repoTW/TW/proyecto/Imagenes/emiliosantiago.png" class="logo"  />
  <nav>
    <ul>
